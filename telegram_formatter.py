    ...
    def _format_verified_intelligence_report(self, signal_result: SignalResult) -> str:
        ...
        if tracker is not None:
            ...
            lines.extend([
                ...
                f"Candidates generated: {learning.get('candidates_generated', learning.get('candidates_evaluated', 0))}",
                f"Candidates rejected: {learning.get('candidates_rejected', 0)}",
                f"Ready candidates: {learning.get('candidates_ready', 0)}",
                f"Simulated trades opened: {learning.get('simulated_trades_opened', 0)}",
